...
import "../utilization/types/UJumpRateUtilizationCurve6.sol";
...
contract MockUJumpRateUtilizationCurve6 {
    ...
    function accumulate(
        ...
        return UJumpRateUtilizationCurve6Lib.accumulate(self, utilization, fromTimestamp, toTimestamp, notional);
    }
}
