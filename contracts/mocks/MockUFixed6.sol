...
contract MockUFixed6 {
    ...
    function fromSignificandAndExponent(uint256 significand, uint256 exponent) external pure returns (UFixed6) {
        return UFixed6Lib.fromSignificandAndExponent(significand, exponent);
    }
